package ru.mirea.osin.intentfilter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener onBtnSendInfo = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                shareIntent.putExtra(Intent.EXTRA_TEXT, "Осин Александр Кириллович");
                startActivity(Intent.createChooser(shareIntent, "О.А.К."));
            }
        };
